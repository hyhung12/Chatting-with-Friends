...
"""
def is_valid_user_inputs(server:str, username:str, password:str, message:str):
    """
    ...
    # Return True/False
    server_bool = is_valid_ip(server)
    usn_bool = is_valid_usr_pwd(username, 'username')
    pwd_bool = is_valid_usr_pwd(password, 'password')
    mesg_bool = is_valid_str(message, 'direct message')
    
    return all([server_bool, usn_bool, pwd_bool, mesg_bool])
